...
import { PriceableType, PricesInsert } from "~/database/schema/prices";
...
const ProductGroupItemsContext = React.createContext<
	| {
			...
			createDefaultPrice: (params: {
				currencyCode: CurrencyCode;
				priceableId: string;
				priceableType: PriceableType;
			}) => Record<CurrencyCode, PricesInsert[]>;
	  }
	| undefined
>(undefined);
...
export function ProductGroupItemsProvider({
	...
	const createDefaultPrice = useCallback(
		({ currencyCode, priceableId, priceableType }) => {
			return {
