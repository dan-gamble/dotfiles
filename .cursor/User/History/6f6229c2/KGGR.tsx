			...
			{productGroupItems.map((key, productGroupItem) => {
				return (
					<React.Fragment key={key}>
						...
						<input
							type="hidden"
							name={productGroupItem.name("productId")}
							defaultValue={productGroupItem.value("productId")}
						/>
						<input
							type="hidden"
							name={productGroupItem.name("variantId")}
							defaultValue={productGroupItem.value("variantId")}
						/>
						<input
							type="hidden"
							name={productGroupItem.name("productGroupId")}
							defaultValue={productGroupItem.value("productGroupId")}
						/>
					</React.Fragment>
				);
			})}
