...
import { SelectedItem } from "~/context/ProductGroupItemsContext";
...
export function AddProductGroupPopover({
	...
	const { mutate } = useMutation<
		typeof import("../../product-groups/$id.selected-items").loader | null
	>({
		mutationFn: async (id: string) => {
			...
			return (await response.json()) as SelectedItem[];
		},
	});
